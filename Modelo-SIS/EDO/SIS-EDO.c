...
Programa que gera uma simulação de uma doença fictícia do modelo SIS (Suscetível-Infectado-Suscetível) utilizando EDOs pelo métodod de Runge-Kutta de quarta ordem.
...
#define N 2 //Número de equações

#define Mu 1.0/100.0 	//Taxa de mortalidade por causas naturais
...
{	int i;
    	double a, b, h, x;
    	double y[N] = {1.0 - Ti, Ti}; //Definindo as quantidades iniciais
