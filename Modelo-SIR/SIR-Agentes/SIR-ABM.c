...
Programa que gera uma simulação de uma doença fictícia do modelo SIR (Suscetível-Infectado-Recuperado) utilizando Método Baseado em Agentes.
...
//Ação para os Agentes Recuperados
